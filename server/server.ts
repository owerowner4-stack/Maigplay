...
const bccBaseUrl = (process.env.BCC_ESCROW_BASE_URL || process.env.BCC_BASE_URL || '').replace(/\/$/, '');
const bccTokenUrl = process.env.BCC_OAUTH_TOKEN_URL || process.env.BCC_TOKEN_URL || '';
